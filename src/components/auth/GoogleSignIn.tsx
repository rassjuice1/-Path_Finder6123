    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <div className="max-w-md w-full bg-gray-800 rounded-xl shadow-2xl p-8 border border-gray-700">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
        >
        ...
        <div className="mt-6 p-4 bg-indigo-900/30 rounded-lg border border-indigo-800">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-indigo-300 font-medium">Demo Mode Available</p>
              <p className="text-xs text-indigo-400 mt-1">
                Without Firebase credentials, you&apos;ll automatically enter demo mode with sample data.
              </p>
            </div>
          </div>
        </div>
